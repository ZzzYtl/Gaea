...
import (
	...
	types "github.com/ZzzYtl/MyMask/parser/tidb-types"
	driver "github.com/ZzzYtl/MyMask/parser/tidb-types/parser_driver"
)
...
func (s *testParserSuite) TestDDLStatements(c *C) {
	...
	for _, colDef := range stmt.Cols {
		c.Assert(colDef.Tp.Charset, Equals, mysql.CharsetBin)
		c.Assert(colDef.Tp.Collate, Equals, mysql.CollationBin)
...
// For issue #51
// See https://github.com/ZzzYtl/MyMask/parser/pull/51 for details
...
// See https://github.com/ZzzYtl/MyMask/parser/issue/94
...
// See https://github.com/ZzzYtl/MyMask/parser/issue/95

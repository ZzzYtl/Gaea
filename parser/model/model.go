...
const (
	...
	// TableInfoVersion1 ColumnInfoVersion1 means the table info version is 1.
...
// GetAutoIncrementColInfo return auto increment column info
...
// IsAutoIncColUnsigned check if auto increment column unsigned
...
const (
	// AlgorithmUndefined undefined algorithm
	AlgorithmUndefined ViewAlgorithm = iota
	// AlgorithmMerge merge algorithm
	AlgorithmMerge
	// AlgorithmTemptable temptable algorithm
	AlgorithmTemptable
)

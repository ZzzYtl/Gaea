...
func DefaultTypeForValue(value interface{}, tp *FieldType) {
	...
	case string:
		...
		tp.Flen = len(x)
		tp.Decimal = UnspecifiedLength
		tp.Charset, tp.Collate = mysql.GetDefaultCharsetAndCollate()
	case float64:
	...
	case json.BinaryJSON:
		...
		tp.Flen = UnspecifiedLength
		tp.Decimal = 0
		tp.Charset = mysql.CharsetBin
		tp.Collate = mysql.CollationBin
	default:
...
func DefaultCharsetForType(tp byte) (string, string) {
	...
	return mysql.CharsetBin, mysql.CollationBin
}
...
var fieldTypeMergeRules = [fieldTypeNum][fieldTypeNum]byte{
	...
	/* mysql.TypeJSON -> */
	{
		...
		//mysql.TypeLongLONG     mysql.TypeInt24
		mysql.TypeVarchar, mysql.TypeVarchar,
		//mysql.TypeDate         TypeDuration
		mysql.TypeVarchar, mysql.TypeVarchar,
		//mysql.TypeDatetime     TypeYear
		mysql.TypeVarchar, mysql.TypeVarchar,
		//mysql.TypeNewDate      mysql.TypeVarchar
		mysql.TypeVarchar, mysql.TypeVarchar,
		//mysql.TypeBit          <16>-<244>
